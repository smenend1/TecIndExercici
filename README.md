...
## v9.1
- Correccio de la impressio de fitxes PAU: ara s'imprimeix nomes la fitxa seleccionada, no la resta de targetes visibles a la pagina.
- Service Worker actualitzat a v9.1.
